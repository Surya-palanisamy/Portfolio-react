      ...
      <div className="container">
        <div className="row justify-content-center pb-5">
          <div className="col-lg-8 col-md-10 text-center heading-section ftco-animate">
            ...
            <p>
              Explore my journey and accomplishments in web development. With
              a strong foundation in the MERN stack and a commitment to
              continuous learning, I am ready to tackle new challenges. Let's
        ...
        <div className="row">
          ...
          <div className="col-lg-6 col-md-12">
            ...
            <div className="resume-wrap ftco-animate mb-4">
              ...
              <span className="position">Sri Sai ram Institute Of Technology</span>
            </div>
          </div>
        </div>
        <div className="row justify-content-center mt-5">
          <div className="col-lg-4 col-md-6 text-center">
            <p>
              <a href="#" className="btn btn-primary py-3 px-4">Download Resume</a>
            </p>
          </div>
        </div>
      </div>
